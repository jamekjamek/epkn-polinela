...
class Document_model extends CI_Model
{
  ...
  public function getAttendanceByRegistrationCount($id)
  {
    return $this->db->query("SELECT COUNT(id) as att_recap, attendance FROM check_point WHERE registration_id = '$id' GROUP BY attendance");
  }
}
