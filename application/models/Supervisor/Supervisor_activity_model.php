...
class Supervisor_activity_model extends CI_Model
{
  ...
  public function getListDailyLog()
  {
    ...
    return $this->db->get_where($this->tableDailyLog, ['supervisor.username' => $this->session->userdata('user')])->result();
  }
  ...
  public function getListAttendance()
  {
    ...
    return $this->db->get_where($this->tableAttendance, ['supervisor.username' => $this->session->userdata('user')])->result();
  }
