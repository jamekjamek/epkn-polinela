<form action="<?= site_url('dosen/data_pkl/assessment/guidance/' . $this->uri->segment('4')) ?>" method="POST" name="guidanceFormD4">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <small class="text-mute font-italic">Kemajuan pelaksanaan PKL (20%)</small>
      </div>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <small class="text-mute font-italic">Pengisian lembar isian kegiatan (25%)</small>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        <input type='text' name='nilai_3' placeholder="Nilai Supervisi" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" />
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <small class="text-mute font-italic">Nilai Supervisi (30%)</small>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <small class="text-mute font-italic">Laporan (25%)</small>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
