              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group has-error">
                    <label for="pic">NIP</label>
                    <input type="text" class="form-control" name="nip" value="<?= set_value('nip') ? set_value('nip') : $profile->nip; ?>" readonly>
                  </div>
                </div><div class="col-md-6">
                  <div class="form-group has-error">
                    <label for="pic">Nama</label>
                    <input type="text" class="form-control" name="name" value="<?= set_value('name') ? set_value('name') : $profile->name; ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group has-error">
                    <label for="telp">Email</label>
                    <input type="text" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" id="telp" placeholder="Masukkan email" name="email" value="<?= set_value('email') ? set_value('email') : $profile->email; ?>">
