                    ...
                    <div class="col-sm-4">
                      <div class="btn-group">
                        ...
                        <?php if ($this->input->get('prodi')) : ?>
                          <a href="<?= base_url($role . '/attendance'); ?>" class="btn btn-danger" style="margin-top: 30px;">Reset</a>
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="<?= site_url($role . '/attendance/detail/' . $student->registration_id) ?>" class="btn btn-outline-secondary">DETAIL</a>
