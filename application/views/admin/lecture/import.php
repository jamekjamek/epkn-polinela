      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-6">
                <form action="<?= base_url('admin/master/lecture/importlecture'); ?>" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>File upload</label>
                    <input type="file" name="importlecture" accept=".xlsx,.xls" class="file-upload-default">
                    ...
                    <div class="scroll-widget">
                      <div class="latest-update-box">
                        <div class="row pt-20 pb-30">
                          ...
                          <div class="col pl-5">
                            <a href="#!">
                              <h6>Pastikan Data Jurusan sudah terisi</h6>
                            </a>
                            <p class="text-muted mb-0">Isilah data jurusan terlebih dahulu untuk mendapatkan ID Jurusan</p>
                          </div>
                        </div>
                        <div class="row pb-30">
                          <div class="col-auto text-right update-meta pr-0">
                          ...
                          <div class="col pl-5">
                            <a href="#!">
                              <h6>Download Format Import Excel Dosen</h6>
                            </a>
                            <p class="text-muted mb-0">Download File template<a href="<?= base_url('assets/uploads/template_dosen.xlsx') ?>" class="text-blue"> Disini</a>
                            </p>
                          </div>
                        </div>
                        <div class="row pb-30">
                          ...
                          <div class="col pl-5">
                            ...
                            <p class="text-muted mb-0">Isilah data sesuai format template, kesalahan pengisian data akan
                              mengakibatkan data tidak bisa masuk ke database</p>
                          </div>
                        </div>
                        <div class="row pb-30">
                          <div class="col-auto text-right update-meta pr-0">
