      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-6">
                <form action="<?= base_url('admin/master/company/importcompany'); ?>" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>File upload</label>
                    <input type="file" name="importcompany" accept=".xlsx,.xls" class="file-upload-default">
                        ...
                        <div class="row pt-20 pb-30">
                          ...
                          <div class="col pl-5">
                            ...
                            <p class="text-muted mb-0">
                              ...
                              <a href="<?= base_url('admin/master/company/exportRegency') ?>" class="text-blue"> Disini</a>
                            </p>
                          </div>
                        </div>
                        <div class="row pb-30">
