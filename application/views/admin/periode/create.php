                ...
                <div class="col-sm-12">
                  ...
                  <?php if ($this->uri->segment(4) === 'registration_period') : ?>
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control <?= form_error('quantity') ? 'is-invalid' : ''; ?>" id="quantity" placeholder="Masukan jumlah" name="quantity" value="<?= set_value('quantity') ?>">
                      <div class="invalid-feedback">
                        <?= form_error('quantity'); ?>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control <?= form_error('starttime') ? 'is-invalid' : ''; ?>" id="starttime" name="starttime" value="<?= set_value('starttime') ?>">
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control <?= form_error('finishtime') ? 'is-invalid' : ''; ?>" id="finishtime" name="finishtime" value="<?= set_value('finishtime') ?>">
                    <div class="invalid-feedback">
