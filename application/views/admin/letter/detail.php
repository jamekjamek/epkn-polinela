                ...
                <div class="card">
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control html-editor <?= form_error('header') ? 'is-invalid' : ''; ?>" rows="10" name="header"><?= set_value("header") ? set_value("header") : $letter->header; ?></textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="document" id="document" class="form-control <?= form_error('document') ? 'is-invalid' : ''; ?>" style="width:100%">
                                            ...
                                            <?php foreach ($document as $documentrow) : ?>
                                                <?php if ($letter->document_id === $documentrow->id) : ?>
                                                    <option value="<?= $documentrow->id ?>" selected><?= $documentrow->name; ?></option>
                                                <?php else : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= form_error('letter-number') ? 'is-invalid' : ''; ?>" id="letter-number" placeholder="Masukan nomor surat" name="letter-number" value="<?= set_value('letter-number') ? set_value('letter-number') : $letter->letter_number; ?>">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="image-preview" id="imagePreviewQuestion" style="height: 200;">
                                            <img class="img-thumbnail image-preview__image" alt="Cinque Terre" src="<?= base_url('assets/img/logo/' . $letter->logo); ?>">
                                            <span class="image-preview__default_text" style="display: none;">Logo Akan Tampil disini
                                                <br>
                                                200x200 px
                                            </span>
                                        </div>
                                        <input type="hidden" name="logo" class="logo" value="<?= $letter->logo; ?>">
                            ...
                            <button type="button" class="btn btn-warning deleteletterconfig" data-id="<?= encodeEncrypt($letter->id); ?>"><i class="ik ik-trash"></i>Hapus</button>
