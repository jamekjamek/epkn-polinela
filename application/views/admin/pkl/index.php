                            ...
                            <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                                <div>
                                    ...
                                    <div class="form-group">
                                        <label for="academicyearyearpkladmin">Tahun Akademik</label>
                                        <select class="form-control" id="academicyearyearpkladmin" style="width:100%" required name="academic">
                                            <option></option>
                                    ...
                                    <?php if ($this->uri->segment(4)) : ?>
                                        <a class="btn btn-info" href="<?= base_url('admin/master/pkl'); ?>">Reset</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
