        ...
        <div class="card">
          <div class="card-header d-block">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <form action="<?= base_url('admin/registration/importregistration'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>File upload</label>
                      <input type="file" name="importregistration" accept=".xlsx,.xls" class="file-upload-default">
                    ...
                    <a href="<?= base_url('admin/registration') ?>" class="btn btn-danger"><i class="ik ik-skip-back"></i>Kembali</a>
                  </form>
                </div>
                <div class="col-sm-6">
                      ...
                      <div class="scroll-widget">
                        <div class="latest-update-box">
                          <div class="row pt-20 pb-30">
                            ...
                            <div class="col pl-5">
                              <a href="#!">
                                <h6>Pastikan Tahun Akademik, Data Prodi, Mahasiswa, Lokasi, dosen sudah terisi</h6>
                              </a>
                              <p class="text-muted mb-0">Isilah data di atas terlebih dahulu untuk mendapatkan ID</p>
                            </div>
                          </div>
                          <div class="row pb-30">
                            <div class="col-auto text-right update-meta pr-0">
                            ...
                            <div class="col pl-5">
                              <a href="#!">
                                <h6>Download Format Import Excel Pendaftaran Kelompok PKN</h6>
                              </a>
                              <p class="text-muted mb-0">Download File template
                                <a href="<?= base_url('assets/uploads/template_registration.xlsx'); ?>" class="text-blue"> Disini</a>
                              </p>
                            </div>
                          </div>
                          <div class="row pb-30">
