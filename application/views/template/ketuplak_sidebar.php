    ...
    <div class="nav-container">
      <nav id="main-menu-navigation" class="navigation-main">
        ...
        <div class="nav-item <?= ($this->uri->segment(2) === 'profile' ? 'active' : '') ?>">
          <a href=" <?= site_url('ketuplak/profile') ?>"><i class="ik ik-user"></i><span>Profil</span></a>
        </div>
        ...
        <div class="nav-item <?= ($this->uri->segment(3) === 'status_pkn' ? 'active' : '') ?>">
          <a href="<?= base_url('ketuplak/recap/status_pkn') ?>"><i class="fa fa-receipt"></i><span>Laporan dan Video PKN</span></a>
        </div>
