    ...
    <div class="nav-container">
      <nav id="main-menu-navigation" class="navigation-main">
        ...
        <div class="nav-item <?= ($this->uri->segment(3) === 'advisers' ? 'active' : '') ?>">
          <a href="<?= base_url('pudir/recap/advisers') ?>"><i class="fa fa-users-cog"></i><span>Dosen Pembimbing</span></a>
        </div>
        <div class="nav-item <?= ($this->uri->segment(3) === 'supervisor' ? 'active' : '') ?>">
          <a href="<?= base_url('pudir/recap/supervisor') ?>"><i class="fa fa-users"></i><span>Pembimbing Lapang</span></a>
        </div>
        <div class="nav-item <?= ($this->uri->segment(3) === 'daily_log' ? 'active' : '') ?>">
          <a href="<?= base_url('pudir/recap/daily_log') ?>"><i class="fa fa-file"></i><span>Jurnal Harian</span></a>
        </div>
        <div class="nav-item <?= ($this->uri->segment(3) === 'attendance' ? 'active' : '') ?>">
          <a href="<?= base_url('pudir/recap/attendance') ?>"><i class="fa fa-clock"></i>Kehadiran</a>
        </div>
