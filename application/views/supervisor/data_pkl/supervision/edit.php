      ...
      <div class="modal-body">
        <form action="<?= site_url('supervisor/data_pkl/assessment/save/' . $this->uri->segment('4')) ?>" method="POST" name="supervisorForm">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type='text' name='nilai_1' placeholder="Pengetahuan terhadap pekerjaan yang dilaksanakan" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" value="<?= $supervisor->nilai_1 ?>" />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type='text' name='nilai_3' placeholder="Penerapan K3" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" value="<?= $supervisor->nilai_3 ?>" />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type='text' name='nilai_4' placeholder="Kerjasama Tim" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" value="<?= $supervisor->nilai_4 ?>" />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type='text' name='nilai_5' placeholder="Kreativitas" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" value="<?= $supervisor->nilai_5 ?>" />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type='text' name='nilai_6' placeholder="Kedisiplinan" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" value="<?= $supervisor->nilai_6 ?>" />
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type='text' name='nilai_7' placeholder="Sikap" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" required="" value="<?= $supervisor->nilai_7 ?>" />
                <small class="text-mute font-italic">Sikap (10%)</small>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type=text name="jumlah_7" class="form-control" onchange='tryNumberFormat(this.form.thirdBox);' readonly="" value="<?= $supervisor->nilaitertimbang_7 ?>">
                <small class="text-mute font-italic">Sikap (10%)</small>
              </div>
              <div class="form-group">
