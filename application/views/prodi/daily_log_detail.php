        ...
        <div class="card">
          <div class="card-header d-block">
            <div class="d-flex flex-grow-1 min-width-zero card-content">
              ...
              <a href="<?= site_url('prodi/daily_log') ?>" class="btn btn-danger"><i class="ik ik-arrow-left"></i> KEMBALI</a>
            </div>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $student->tool; ?></td>
                      <td>
                        <button type="button" class="btn btn-warning modalLogIdAll" data-toggle="modal" data-target="#modalLogIdAll" data-log="<?= $row->id; ?>" data-role="<?= $this->session->userdata('role') ?>" data-menu="daily_log/detail_more"><i class="ik ik-eye"></i><span>Selengkapnya</span></button>
                      </td>
                    </tr>
                  <?php $i++;
                  endforeach; ?>
