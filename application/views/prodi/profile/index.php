              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group has-error">
                    ...
                    <input type="text" class="form-control" name="name" value="<?= set_value('name') ? set_value('name') : $profile->lecture; ?>" readonly>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group has-error">
                    <label for="telp">Email</label>
                    <input type="text" class="form-control" id="telp" placeholder="Masukkan email" name="email" value="<?= set_value('email') ? set_value('email') : $profile->email; ?>" readonly>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group has-error">
