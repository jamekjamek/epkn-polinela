    ...
    <tbody>
        <tr>
            <td style="width: 23%;" align="center">
                <img src="<?= base_url('assets/img/logo/logo.png') ?>" alt="" width="100" height="100" />
            </td>
            <td style="text-align: center;">
                <p></p>
                <h3 style="text-align: center;"><span style="font-family: Times New Roman;"><b>KEMENTRIAN PENDIDIKAN DAN KEBUDAYAAN</b></span></h3>
                ...
                <span style="text-align: center;"><span style="font-family: Times New Roman;">Jl. Soekarno - Hatta No. 10, Rajabasa - Bandar Lampung</span></span>
